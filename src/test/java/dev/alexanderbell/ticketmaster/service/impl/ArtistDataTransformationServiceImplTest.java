...
class ArtistDataTransformationServiceImplTest {
    ...
    void retrieveListOfArtistWithEvents() {
        ...
        List<EventDTO> eventDTOS = Collections.singletonList(e1);
        ...
        when(modelMappingService.artistDTOListToArtistList(artistDTOS)).thenReturn(Collections.singletonList(expectedArtist));
        List<Event> expectedEventList = Collections.singletonList(new Event(1L, "Summer concert", "once", "London", "10/03/2020",
