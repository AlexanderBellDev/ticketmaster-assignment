...
Requirements:
    ...
    Create routes to:
        ...
        Get venue information for a specicic venueId. This should contail all fields of given venue and all events happening at this venue.
...
* The service should fetch the files from S3
...
We do use things like SpringBoot, lombok to make our lives easier in our day-to-day development. Feel free to do the same.
If you do use a library then explain why in the readme.
...
* If time allows, we will ask you to make a minor change to the program.
